...
and the schema migration) and **41 frontend tests** (the cross-language scoring
parity fixture, name casing, keyboard navigation, and a structural layout
guard), `ruff` clean, `mypy --strict` clean across 36 modules, `oxlint` clean,
`tsc -b` clean.
